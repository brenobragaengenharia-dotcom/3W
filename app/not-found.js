...
export default function NotFound() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-24 text-center">
      <p className="text-[#e50914] font-black text-8xl mb-4">404</p>
      ...
      <div className="flex items-center gap-3 flex-wrap justify-center">
        <Link href="/" className="bg-[#e50914] hover:bg-[#b30710] text-white font-semibold px-6 py-3 rounded-lg transition-colors text-sm">
          Voltar para a home
        </Link>
