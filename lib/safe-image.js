...
//   → placeholder categórico (motogp/stockcar/dtm/f1)
//   → card /api/og com título e categoria
//   → PLACEHOLDER estático (último recurso, sem título disponível).
export function safeImage(url, contexto = {}) {
  ...
  const fallback = categorical || dynamic || PLACEHOLDER;
