...
export const FILMES = [
  ...
  { id: 2, slug: 'um-amor-de-mentiras', titulo: 'Um Amor de Mentiras', ano: 2026, nota: 7.2, categoria: 'Romance', imagem: 'https://image.tmdb.org/t/p/w500/hXNn25hE2SH2kHMPVOLjqDISSxf.jpg' },
  ...
  { id: 4, slug: 'cara-de-um-focinho-de-outro', titulo: 'Cara de Um, Focinho de Outro', ano: 2026, nota: 7.6, categoria: 'Animação', imagem: 'https://image.tmdb.org/t/p/w500/ftPFJBGbldoWiiPrmesW96zBzdH.jpg' },
  { id: 5, slug: 'ataque-brutal', titulo: 'Ataque Brutal', ano: 2026, nota: 6, categoria: 'Terror', imagem: 'https://image.tmdb.org/t/p/w500/349RbnEbWd38iLlqzELTUppjSt2.jpg' },
  { id: 6, slug: 'the-mortuary-assistant', titulo: 'The Mortuary Assistant', ano: 2026, nota: 5.5, categoria: 'Terror', imagem: 'https://image.tmdb.org/t/p/w500/mc3nj2DI1MZeFoAR08zSRDxezzf.jpg' },
  { id: 7, slug: 'bola-pra-cima', titulo: 'Bola pra Cima', ano: 2026, nota: 5.6, categoria: 'Comédia', imagem: 'https://image.tmdb.org/t/p/w500/9uMTLWiDPFWYxEwP11G9Sp9cVAk.jpg' },
  ...
  { id: 9, slug: 'o-atirador-sem-nacao', titulo: 'O Atirador: Sem Nação', ano: 2026, nota: 6.2, categoria: 'Ação', imagem: 'https://image.tmdb.org/t/p/w500/gGhjs14pomQA6N8parCw5Bl3qoh.jpg' },
  { id: 10, slug: 'destruicao-final-2', titulo: 'Destruição Final 2', ano: 2026, nota: 6.5, categoria: 'Aventura', imagem: 'https://image.tmdb.org/t/p/w500/s6nzVekLSd1y0vGjLz8WPfC1Sau.jpg' },
  { id: 11, slug: 'caminhos-do-crime', titulo: 'Caminhos do Crime', ano: 2026, nota: 7, categoria: 'Crime', imagem: 'https://image.tmdb.org/t/p/w500/3u8Pr8WF9hqMptlnuYL52YXSs8F.jpg' },
  { id: 12, slug: 'um-cabra-bom-de-bola', titulo: 'Um Cabra Bom de Bola', ano: 2026, nota: 7.9, categoria: 'Animação', imagem: 'https://image.tmdb.org/t/p/w500/x0SRTrltSJi1iQiIAUpyvkxnr41.jpg' },
];

// ─── PARCERIA INGRESSO.COM ───────────────────────────────────────────────────
export const INGRESSO_URL = 'https://www.ingresso.com/';
...
export const SERIES = [
  ...
  { id: 2, slug: 'euphoria', titulo: 'Euphoria', ano: 2019, nota: 8.3, categoria: 'Drama', imagem: 'https://image.tmdb.org/t/p/w500/aJrG7OkoTMPWG5c8opz8a93AZPY.jpg' },
  ...
  { id: 4, slug: 'invencivel', titulo: 'INVENCÍVEL', ano: 2021, nota: 8.6, categoria: 'Animação', imagem: 'https://image.tmdb.org/t/p/w500/qhb7RWU9ad9a5m3HbeRRXzjaMXf.jpg' },
  { id: 5, slug: 'origem', titulo: 'Origem', ano: 2022, nota: 8.2, categoria: 'Mistério', imagem: 'https://image.tmdb.org/t/p/w500/j4DJV91VGx7eAIWPeolV0nOtT1G.jpg' },
...
export const NOTICIAS_FUTEBOL = [
  ...
  },
  {
    ...
    imagem: 'https://static.sambafoot.com/wp/sites/2/Captura-de-tela-2025-11-19-141636-768x425.webp', tempo_leitura: 6,
  },
];
...
export const NOTICIAS = [
  ...
  {
    id: 2, slug: 'the-last-of-us-s2-estreia',
    titulo: 'The Last of Us T2: Estreia quebra recordes na HBO e Max',
  ...
  {
    id: 3, slug: 'daredevil-born-again-review',
    titulo: 'Review: Daredevil Born Again é o melhor da Marvel no streaming',
  ...
  {
    id: 4, slug: 'copa-do-mundo-2026-brasil',
    titulo: 'Copa do Mundo 2026: Brasil no Grupo A — análise completa',
  ...
  {
    id: 5, slug: 'marvel-guerra-secreta-review',
    titulo: 'Marvel: Guerra Secreta 2025 — a HQ que vai mudar tudo',
...
export const TRENDING = [
  { posicao: 1, titulo: 'Avengers: Doomsday',    tipo: 'Filme',   url: '/noticias/avengers-doomsday-elenco-completo', imagem: 'https://image.tmdb.org/t/p/w500/8HkIe2i4ScpCkcX9SzZ9IPasqWV.jpg' },
  { posicao: 2, titulo: 'Copa do Mundo 2026',    tipo: 'Esporte', url: '/noticias/copa-do-mundo-2026-brasil',         imagem: 'https://static.sambafoot.com/wp/sites/2/Captura-de-tela-2025-11-19-141636-768x425.webp' },
  { posicao: 3, titulo: 'The Last of Us T2',     tipo: 'Série',   url: '/noticias/the-last-of-us-s2-estreia',         imagem: 'https://image.tmdb.org/t/p/w500/2TpP0oApo9M7dKF2MkoYKOxRbb.jpg' },
  { posicao: 4, titulo: 'Daredevil: Born Again', tipo: 'Série',   url: '/noticias/daredevil-born-again-review',       imagem: 'https://image.tmdb.org/t/p/w500/xDUoAsU8lQHOOoRkFiBuarmACDN.jpg' },
  { posicao: 5, titulo: 'Marvel: Guerra Secreta',tipo: 'Comics',  url: '/comics/marvel-guerra-secreta-2025',          imagem: 'https://cdn.marvel.com/u/prod/marvel/i/mg/9/b0/51dee6dd91671/portrait_uncanny.jpg' },
];
