...
export const FILMES = [
  ...
  { id: 8, slug: 'maldicao-da-mumia', titulo: 'Maldição da Múmia', ano: 2026, nota: 6.9, categoria: 'Terror', imagem: 'https://image.tmdb.org/t/p/w500/ubN87iHY2DyWtwU2JHS0SQ1KqJu.jpg' },
...
export const NOTICIAS = [
  {
    id: 103, slug: 'xbox-game-pass-e-discord-preparam-nova-parceria-com-beneficios-para-assinantes', titulo: 'Xbox Game Pass e Discord preparam nova parceria com benefícios para assinantes',
    descricao: 'A Microsoft confirmou que está unindo forças com o Discord novamente, mas os detalhes do acordo ainda permanecem em segredo.',
    categoria: 'Games', autor: 'Redação 3W', data: '2026-04-23',
    imagem: 'https://www.adrenaline.com.br/wp-content/uploads/2026/04/microsoft-prepara-parceria-misteriosa-entre-xbox-game-pass-e-discord-1-640x400.jpg', tempo_leitura: 4,
  },
  {
    id: 102, slug: 'ubisoft-em-promocao-na-nuuvem-jogos-com-ate-85-de-desconto', titulo: 'Ubisoft em promoção na Nuuvem: jogos com até 85% de desconto',
    descricao: 'Títulos como Far Cry 6, Assassin\'s Creed Valhalla e Immortals Fenyx Rising estão com preços bem abaixo do habitual por tempo limitado.',
    categoria: 'Games', autor: 'Redação 3W', data: '2026-04-23',
    imagem: 'https://www.adrenaline.com.br/wp-content/uploads/2024/05/assassins-creed-odyssey-640x400.jpg', tempo_leitura: 4,
  },
  {
    id: 101, slug: 'nintendo-switch-2-com-mario-kart-world-tem-r100-de-desconto-no-mercado-livre', titulo: 'Nintendo Switch 2 com Mario Kart World tem R$100 de desconto no Mercado Livre',
    descricao: 'Bundle do Nintendo Switch 2 com Mario Kart World está com cupom de R$100 OFF disponível diretamente na página do Mercado Livre.',
    categoria: 'Games', autor: 'Redação 3W', data: '2026-04-23',
    imagem: 'https://sm.ign.com/ign_br/screenshot/default/nintendo-switch-2-mario-kart-world-thumb-ign_equf.jpg', tempo_leitura: 4,
  },
  {
