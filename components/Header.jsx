          ...
          <div className="pb-3">
            <form role="search" onSubmit={handleSearchSubmit} className="relative">
              ...
              <input
                ...
                autoFocus
                autoComplete="off"
                className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg px-4 py-2.5 pr-12 text-white placeholder-[#737373] focus:border-[#FF6600] focus:outline-none text-sm"
              />
              <button
                type="submit"
                aria-label="Buscar"
