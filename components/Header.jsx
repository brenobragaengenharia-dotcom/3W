      ...
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="pb-3">
            <form role="search" onSubmit={handleSearchSubmit} className="relative">
              ...
              <input
                ...
                autoFocus
                autoComplete="off"
                className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg px-4 py-2.5 pr-12 text-white placeholder-[#9ca3af] focus:border-[#FF6600] focus:outline-none text-sm"
              />
              <button
                type="submit"
                aria-label="Buscar"
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#b3b3b3] hover:text-[#FF6600] transition-colors"
              >
        ...
        {menuOpen && (
          <nav role="navigation" aria-label="Menu mobile" className="md:hidden pb-4">
            ...
            <form role="search" onSubmit={handleSearchSubmit} className="relative mb-3">
              ...
              <input
                ...
                value={searchQuery}
                onChange={e => setSearchQuery(e.target.value)}
                placeholder="Buscar filmes, séries, comics..."
                autoComplete="off"
                className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg px-4 py-2.5 pr-12 text-white placeholder-[#9ca3af] focus:border-[#FF6600] focus:outline-none text-sm"
              />
              <button
